<template>
    <a-layout-header :collapsed="collapsed" @toggle="collapsed = !collapsed" height="50">
        <div class="logo"></div>
        <a-menu :default-selected-keys=defaultActivate theme="dark" mode="horizontal" :style="{ lineHeight: '64px' }">
